...
<style>
  ...
  @media (prefers-color-scheme: dark) {
    .email-body  { background:#eef2f7 !important; }
    .email-card  { background:#ffffff !important; }
    .email-head  { background:#071a44 !important; }
    .email-foot  { background:#071a44 !important; }
    .email-title { color:#ffffff !important; }
    .email-sub   { color:rgba(255,255,255,.55) !important; }
    .email-text  { color:#4a5568 !important; }
    .email-alt   { color:#a0aec0 !important; background:#f7f9fc !important; }
    .email-exp   { background:#fff8f8 !important; }
    .email-btn a { background:#c8102e !important; color:#ffffff !important; }
  }
</style>
</head>
<body class="email-body" style="margin:0;padding:0;background:#eef2f7;font-family:Arial,Helvetica,sans-serif;">
<table width="100%" cellpadding="0" cellspacing="0" class="email-body" style="background:#eef2f7;padding:48px 16px;">
<tr><td align="center">
<table width="100%" cellpadding="0" cellspacing="0" class="email-card"
  ...
  <tr><td class="email-head" style="background:#071a44;padding:36px 40px 28px;text-align:center;">
    ...
    <div class="email-title" style="font-size:48px;font-weight:900;color:#fff;letter-spacing:.04em;line-height:1;">GUIDO</div>
    <div class="email-sub" style="font-size:12px;color:rgba(255,255,255,.55);margin-top:6px;letter-spacing:.1em;text-transform:uppercase;">Siempre cerca de ti</div>
  ...
  <tr><td style="padding:40px 44px 32px;">
    ...
    <p class="email-text" style="font-size:15px;color:#4a5568;line-height:1.7;margin:0 0 10px;">
    ...
    <p class="email-text" style="font-size:15px;color:#4a5568;line-height:1.7;margin:0 0 32px;">
    ...
    <p class="email-alt" style="font-size:11px;color:#a0aec0;word-break:break-all;margin:0 0 32px;
              background:#f7f9fc;padding:12px 16px;border-radius:8px;border-left:3px solid #c8102e;">
      ${reset_link}
    </p>
    <table width="100%" cellpadding="0" cellspacing="0">
    <tr><td class="email-exp" style="background:#fff8f8;border:1px solid #fde8e8;border-radius:8px;padding:14px 18px;">
  ...
  <tr><td class="email-foot" style="background:#071a44;padding:24px 40px;text-align:center;">
